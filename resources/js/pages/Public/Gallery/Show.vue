        ...
        <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-12">
                ...
                <div
                    ...
                    class="mt-4 flex items-center gap-4 text-muted-foreground"
                >
                ...
                <div
                    ...
                    class="prose prose-neutral dark:prose-invert mt-6 max-w-none"
            ...
            >
                <button
                    ...
                    :key="photo.id"
                    class="group relative aspect-square overflow-hidden rounded-lg focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:outline-none"
