    ...
    <section class="py-20">
        <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <div class="absolute bottom-0 left-0 right-0 p-6 text-white">
                            ...
                            <div class="mt-2 flex items-center gap-4 text-sm text-white/80">
                                <span v-if="album.photo_count" class="flex items-center gap-1">
                    ...
                    >
                        <Card class="overflow-hidden transition-all hover:shadow-lg">
                            ...
                            <CardContent class="p-4">
                                <h3 class="font-semibold group-hover:text-primary">{{ album.title }}</h3>
                                <p v-if="album.summary" class="mt-1 line-clamp-2 text-sm text-muted-foreground">
                                    {{ album.summary }}
                                </p>
            ...
            <div v-if="!albums.length" class="py-20 text-center">
                ...
                <p class="mt-2 text-muted-foreground">Check back later for photo galleries</p>
            </div>
        </div>
    </section>
</template>
