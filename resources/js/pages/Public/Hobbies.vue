    ...
    <section class="py-20">
        <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-14 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                ...
                >
                    <Card
                        class="h-full overflow-hidden transition-all hover:border-foreground/20 hover:shadow-lg"
                    >
                        <div
                            v-if="hobby.image"
                        ...
                        <CardHeader>
                            <CardTitle
                                class="transition-colors group-hover:text-primary/80"
                                >{{ hobby.title }}</CardTitle
                            >
                        </CardHeader>
                        <CardContent>
                            <p
